...
import 'package:bacaan_sholat/page/gerakan_sholat_page.dart';
                ...
                child: Expanded(
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage("assets/images/gb_niat.jpg"),
                          height: 100,
                          width: 100,
                        ),
                        SizedBox(height: 10),
                ...
                child: Expanded(
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage("assets/images/gb_sholat.jpg"),
                          height: 100,
                          width: 100,
                        ),
                        SizedBox(height: 10),
                ...
                child: Expanded(
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage("assets/images/gb_quran.jpg"),
                          height: 100,
                          width: 100,
                        ),
                        SizedBox(height: 10),
                ...
                child: Expanded(
                  child: InkWell(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage("assets/images/jb_sholat.jpg"),
                          height: 100,
                          width: 100,
                        ),
                        SizedBox(height: 10),
